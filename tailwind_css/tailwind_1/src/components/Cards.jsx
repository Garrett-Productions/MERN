        ...
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
            <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-200'>
                ...
                <div className='text-center font-medium'>
                    ...
                    <p className='py-2 border-b mx-8 '> Send up to 2 GB of data</p>
                </div>
                <button className='bg-[#00df9a] w-[200px] rounded-full font-medium my-6 mx-auto px-6 py-3 text-black'>Start Trial</button>
            </div>
