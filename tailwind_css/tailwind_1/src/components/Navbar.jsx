...
import {AiOutlineClose, AiOutlineMenu} from 'react-icons/ai' // 2 icons, for our menu handler
...
const Navbar = () => {
  ...
  return ( // we are handling mobile first below!!
    <div className='text-white flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4'>
        ...
        <div onClick={handleNav} className='block md:hidden'> 
          { // once we get over the median breakpoint on line 21(768 px) we want to hide that input. sm: is 640px by default
           // tailwind is very mobile friendly first
